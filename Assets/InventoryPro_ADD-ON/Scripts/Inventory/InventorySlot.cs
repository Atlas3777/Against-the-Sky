...
namespace cowsins.Inventory
{
    ...
    public class InventorySlot : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
    {
        ...
        /// <param name="weaponController">Reference to the Player큦 WeaponController</param>
        ...
        private void ShowTooltip()
        {
            ...
            if (CanShowTooltip())
            {
                //Always show the tooltip based on the Anchor큦 Item
        ...
        public void UpdateSlotGraphics()
        {
            ...
            if (anchorSlot && !IsHotbarSlot)
            {
                ...
                {
                    // This InventorySlot is anchored to a slot that큦 not itself. This can only happen in Tetris Inventory.
