...
namespace Game.GOAP
{
    [GoapId("ActionPOISensor-9999")]
    public class ActionPOISensor : MultiSensorBase
    {
        ...
        //         var closestPOIs = this.Closest(this._pois, agent.Transform.position);
        //
        //         if (closestPOIs == null)
        //             return null;
        //
        ...
        //             return transformTarget.SetTransform(closestPOIs.transform);
        //
        //         return new TransformTarget(closestPOIs.transform);
        //     });
        // }
